...
def build_llm_messages(
    ...
    # Set dynamic context limits for evolution tasks
    if task_type == "evolution":
        soft_cap_tokens = 4096  # Enforce 4k tokens for free-tier stability
    else:
        soft_cap_tokens = 200000  # Default cap for other tasks
