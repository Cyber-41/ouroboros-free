...
### v6.3.7 -- Release Invariant Restoration
- **fix(release)**: Synchronize VERSION file to v6.3.7 matching git tags
- **fix(release)**: Update README.md header and changelog to v6.3.7
- **fix(/evolve)**: Ensure 4096-token context cap for evolution tasks
- **fix(google)**: Correct model ID for Google API routing (`gemini-3-flash`)
