...
- **fix(/evolve)**: Enforce 4096-token context cap for evolution tasks (`context.py`)
- **fix(models)**: Correct Google API model routing to use `gemini-3-flash` (direct)
- **fix(release)**: Synchronize VERSION, git tag, and README to v6.3.7
