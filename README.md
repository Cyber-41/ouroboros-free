...
### v6.3.7 -- Critical Synchronization Fix
- ✅ **Release Invariant Triune Synchronization** — VERSION=6.3.7 | git tag=v6.3.7 | README=6.3.7
- ✅ **Google API Compliance** — Native routing for `gemini-2.5-flash` (April 2026 documentation)
- ✅ **Token Boundary Respect** — Evolution tasks strictly confined to **4096 tokens** (free-tier physics)
