...
- **Critical: Restored Release Invariant** -- VERSION file, git tag v6.3.7, and README changelog now perfectly synchronized
- **Model Physics Correction** -- Replaced invalid `gemini-3-flash` with valid `gemini-2.5-flash` for Google API free tier compliance
- **Context Enforcement** -- Strict 4096-token cap now properly enforced for evolution tasks
