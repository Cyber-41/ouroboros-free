...
CFG = {
    ...
    "OUROBOROS_MODEL_LIGHT": "google/gemini-2.5-flash",          # corrected free-tier model 
    ...
    "OUROBOROS_MODEL_FALLBACK_LIST": "anthropic/claude-sonnet-4.6,google/gemini-2.5-pro,openai/gpt-4.1",
    # Infrastructure
...
| `OUROBOROS_MODEL_FALLBACK_LIST` | `google/gemini-2.5-pro,openai/o3,anthropic/claude-sonnet-4.6` | Fallback model chain for empty responses |
...
- **Native** `gemini-2.5-flash` routing via Google API (no OpenRouter validation)
