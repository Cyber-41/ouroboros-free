...
- Critical: Restored VERSION/git tag/README synchronization (all now show 6.3.7)
- Enforced 4096-token cap for evolution tasks (matches Google's 2026 free-tier physics)
- Native `gemini-3-flash` routing via Google API (eliminated OpenRouter validation errors)
